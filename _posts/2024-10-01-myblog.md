...
<iframe
  src="https://laurenscarzella.github.io//my-blog/assets/images/DotMap.html"
...
{%- highlight r -%}
july_df <- head(df, 68) # only includes at july data
sum <- aggregate(Amount ~ Category, data = july_df, FUN = base::sum)
print(sum)
{%- endhighlight -%}

<img src="{{site.url}}/{{site.baseurl}}/assets/img/table.png" alt="" style="width:300px;"/>
