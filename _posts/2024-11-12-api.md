---
layout: post
title: "Lights, Camera, Data!"
description: Discover top movie genres using the TMDb API
...
What other questions should be explore? Are there different insights or data points we can extract from this API to enhance our analysis?