...
### Explore the Data
If you would like to see the code for data exploration click [here.]()
...
### What Are the Top 10 Most Popular Movies by Genre?
I wanted to focus on the most popular movie genre Science Fiction. However, you can choose from any other genre from the dropdown menu generated from [this code]() in Python.
