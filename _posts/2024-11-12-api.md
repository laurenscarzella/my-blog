...
The final dataset has a total of 9921 observations with 4 numeric variables and 5 categorical variables.
...
**Summary Statistics:** This gives us an overview of the range, average, and spread of the data.
