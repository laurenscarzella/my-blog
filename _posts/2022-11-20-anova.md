...
|------------|-------------------------------------------------------------------------------------|----------|
| Person     | 1-20: each number indicates a different person                                      | factor   |
| Treatment  | 1-6: each number represents a different combination of milk and cereal              | factor   |
| Cereal     | ON: name-brand cereal, OFF: off-brand cereal                                        | factor   |
| Milk       | 2%, Almond, Soy                                                                     | factor   |
| Rank       | 1-10: tastiness score of the cereal and milk combination. 1 = Bad and 10 = Perfect  | numeric  |
